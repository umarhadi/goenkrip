...
<head>
  ...
  <title>Dekripsi - Implementasi Metode Enkripsi AES 128 Bit pada Data Laporan Keuangan</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Form Deskripsi</h6>
                </div>
                <div class="card-body">
                  <?php
                  ...
                  ?>
                  <h4>Dekripsi File <b><?php echo $data2['file_name_finish'] ?></b></h4><br>
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            ...
            <span>Copyright &copy; Goenkrip Kantor Desa Krapyak Triharjo Sleman 2023</span>
            </div>
          </div>
        </footer>
      </div>
      ...
      <!-- Page level plugins -->
      <script src="https://cdn.statically.io/gh/umarhadi/goenkrip/main/vendor/chart.js/Chart.min.js"></script>

      <!-- Page level custom scripts -->
      <script src="https://cdn.statically.io/gh/umarhadi/goenkrip/main/js/demo/chart-area-demo.js"></script>
      <script src="https://cdn.statically.io/gh/umarhadi/goenkrip/main/js/demo/chart-pie-demo.js"></script>
