              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-1">Implementasi<br>Metode Enkripsi AES 128 Bit<br>pada Data Laporan Keuangan</h1>
                    <img src="assets/assets2/img/logo1.png" class="mt-2 mb-4" width="100">
                  </div>
                  ...
                  <div class="copyright text-center my-auto">
                    <span>Copyright &copy;denipras <?= date('Y'); ?> </span>
                  </div>
